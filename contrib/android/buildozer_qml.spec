...
title = Elektron Electrum

# (str) Package name
package.name = ElektronElectrum

# (str) Package domain (needed for android/ios packaging)
package.domain = org.elektronnet
...
android.add_jars = .buildozer/android/platform/*/build/libs_collections/ElektronElectrum/jar/*.jar
